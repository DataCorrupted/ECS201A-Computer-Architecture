...
\problem{
    ...
    The begining address always ends with 2 zeros.
}
...
\problem{
    ...
    How many operands are \textbf{explicitly} used in instruction.
}
...
\problem{
    ...
    However, there are times when register allocation is difficult to do while maintaining programam correctness - explain why.
}{
    \todo
}
