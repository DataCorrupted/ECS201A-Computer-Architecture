...
\problem{
    ...
    Also, explain the underlying assumption that is being made, and why it is that we are still making narrow fast machines.
     ...
     - slow and wide machines have lower clock rates and possibly lower Vdd, therefore lower power consumption. So it is more energy efficient. \\
     - It assumes there is enough parallelism available. \\
     - However, it is often we don't have enough parallelism. In this case, slow and wide machine wastes energy. Thus, we still use narrow and fast machines.
}
...
\problem{
    ...
    (These have to be different - in other words, if the advantage of superscalar is X, then you can’t say a disadvantage of VLIW is that it can’t do X.)
     ...
     - superscalar: hardware does dynamic schduling \\
