...
If there is only one midterm in that quater, use \texttt{m0}
...
Farrens (unwisely) put all his pdf under one folder that is publically available, making all files easy to craw.
